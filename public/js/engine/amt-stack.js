...
function AmtStackCreateService(wsmanStack) {
    ...
    obj.AmtStatusCodes = {
        ...
        0x0803: 'PT_STATUS_INVALID_KERBEROS_SETTINGS',
        // Network / remote-access range (0x080x): AddMpServer / AddRemoteAccessPolicyRule / cert methods.
        0x0805: 'INVALID_HANDLE', 0x0806: 'INVALID_PASSWORD', 0x0809: 'DATA_MISSING', 0x080A: 'DUPLICATE',
        0x080F: 'INVALID_CERT', 0x0810: 'CERT_KEY_NOT_MATCH', 0x0814: 'NOT_FOUND', 0x0815: 'INVALID_CREDENTIALS',
        0x0821: 'USER_CONSENT_REQUIRED',
        0x1600: 'DOT_STATUS_INVALID_CREDENTIALS',
