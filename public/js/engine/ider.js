/**
 * Intel(R) AMT IDER (IDE Redirection) module — serves a floppy .img / CD-ROM .iso
 * image to Intel AMT over the redirection channel so the machine can boot from it.
 * Vendored from MeshCommander (Apache-2.0).
 */
